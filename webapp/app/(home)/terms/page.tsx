	...
	return (
		<section className="min-h-screen grid lg:grid-cols-2 gap-8 lg:gap-12 items-center px-4 lg:px-12 py-8 lg:py-0">
			<div className="flex-col justify-center space-y-6 lg:space-y-8 my-28">
				...
				<h2>2. Use License</h2>
				<p>Permission is granted to temporarily use TheDataWorkspace for personal or business data analysis purposes, subject to the restrictions in these Terms. This license shall automatically terminate if you violate any of these restrictions.</p>

				<h2>3. User Accounts</h2>
				<p>To access certain features of TheDataWorkspace, you may be required to create an account. You are responsible for maintaining the confidentiality of your account information and for all activities that occur under your account.</p>

				<h2>4. User Data</h2>
				<p>You retain all rights to your data. By uploading data to TheDataWorkspace, you grant us a license to use, process, and store that data solely for the purpose of providing our services to you.</p>
				...
				<p>TheDataWorkspace reserves the right to modify these terms at any time. We will notify users of any material changes to these terms.</p>

				<h2>9. Contact Us</h2>
				<p>If you have any questions about these Terms, please contact us using the Contact Us link in the footer.</p>
			</div>
		</section>
	);
}
