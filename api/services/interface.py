...
class ArcSQL(BaseModel):
    name: str = Field(description="The name or identifier of the result. This can be like a name of the KPI, chart, table, etc that will be used as a lable in the report. Capitalize the first letter of each word and use spaces insteade of _. Example: 'Total Revenue'")
    description: str = Field(description="A business-oriented explanation of what the result represents and how it can be used for decision-making. This will be used as a description in the report. Example: 'Total revenue generated by the company in the last quarter.'")
