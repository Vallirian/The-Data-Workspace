...
DEMO_DATA_0 = {
	"metadata": {
		...
		"table_column_meta": [
			...
			{ "Price": { "dtype": "float", "format": "", "description": "Price of the product in USD" } },
			{ "Quantity": { "dtype": "integer", "format": "", "description": "Number of units sold" } },
			{ "Payment Method": { "dtype": "string", "format": "", "description": "Method of payment used by the customer" } },
			{ "State": { "dtype": "string", "format": "", "description": "State where the sale was made" } },
			{ "Date": { "dtype": "date", "format": "YYYY-MM-DD", "description": "Date of the sale" } },
			{ "Rating": { "dtype": "integer", "format": "", "description": "Rating of the product by the customer. Ranges from 1 to 5" } }
		]
	},
    "data": [
        {
        ...
        {
            "Category": "Automotive",
            "Product Name": "Steering Wheel Cover",
            "Price": 14.99,
            "Quantity": 3,
            "Payment Method": "Gift Card",
            "State": "Virginia",
